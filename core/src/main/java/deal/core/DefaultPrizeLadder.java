...
public final class DefaultPrizeLadder implements PrizeLadderProvider {
  @Override public List<Integer> amountsFor(int caseCount) {
    ...
    return switch (caseCount) {
      ...
      case 25 -> List.of(
          ...
          750, 1_000, 2_500, 5_000, 7_500, 10_000, 15_000, 25_000, 50_000,
          75_000, 100_000, 200_000, 300_000, 400_000, 500_000);

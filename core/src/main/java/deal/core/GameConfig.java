...
public final class GameConfig {
  ...
  public GameConfig(int caseCount, PrizeLadderProvider ladder, RoundPolicy roundPolicy) {
    ...
    if (amounts.size() != caseCount)
      throw new IllegalArgumentException("ladder size (" + amounts.size() + ") != caseCount " + caseCount);
  }

  public int caseCount() { return caseCount; }
  public List<Integer> amountsCents() { return List.copyOf(ladder.amountsFor(caseCount)); }
  public RoundPolicy roundPolicy() { return roundPolicy; }
